...
- **Tenancy**: Default
  ![Cấu hình VPC Wizard phần 1](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.2-VPC-Network/vpc-wizard-1.png)
...
![Cấu hình VPC Wizard phần 2](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.2-VPC-Network/vpc-wizard-2.png)
...
![Cấu hình VPC Wizard phần 3](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.2-VPC-Network/vpc-wizard-3.png)
...
![Chọn tab Flow logs và bấm Create flow log](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.2-VPC-Network/flow-logs-1.png)
...
![Cấu hình chi tiết VPC Flow logs](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.2-VPC-Network/flow-logs-2.png)
