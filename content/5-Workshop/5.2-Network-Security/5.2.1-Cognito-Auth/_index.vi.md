...
![Khởi tạo Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/create-user-pool.png)
...
![Khởi tạo Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/define-your-app.png)
...
![Khởi tạo Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/configure-options.png)
...
![Khởi tạo Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/add-a-return.png)
...
![Trích xuất thông tin kết nối](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/user-pool-id.png)
3. Di chuyển qua tab **App integration** ➔ cuộn xuống phần **App client list** ➔ Sao chép lại **Client ID** (dạng `3n70abcde...`).
![Trích xuất thông tin kết nối](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/client-id.png)
