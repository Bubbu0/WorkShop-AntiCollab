...
![Create Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/create-user-pool.png)
...
![Create Cognito User Pool](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/define-your-app.png)
...
![Extract credentials](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/user-pool-id.png)
3. Navigate to the **App integration** tab ➔ Scroll down to the **App client list** ➔ Copy the **Client ID** (e.g., `3n70abcde...`).
![Extract credentials](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/client-id.png)
