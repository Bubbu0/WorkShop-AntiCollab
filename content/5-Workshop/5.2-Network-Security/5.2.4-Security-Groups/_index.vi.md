...
![Cấu hình inbound rule cho alb-sg](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.3-Security-Groups/alb-sg.png)
...
![Cấu hình inbound rule cho unified-backend-sg](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.3-Security-Groups/unified-backend-sg.png)

##### 2.3 Rules cho rds-sg
- **Inbound Rules**:
  - Type: PostgreSQL | Port: `5432` | Source: chọn backend-sg

![Cấu hình inbound rule cho rds-sg](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.3-Security-Groups/rds-sg.png)

##### 2.4 Rules cho redis-sg
- **Inbound Rules**:
  - Type: Custom TCP | Port: `6379` | Source: chọn backend-sg

![Cấu hình inbound rule cho redis-sg](/WorkShop-AntiCollab/images/5-Workshop/5.2-Network-Security/5.2.3-Security-Groups/redis-sg.png)
