...
![Khởi tạo ECS Cluster](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/ecs-cluster-create.png)
...
![Khởi tạo ECS Cluster Phần 1](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/ecs-task-json-1.png)

- **Monitoring**: **Tích chọn** Container Insights

![Khởi tạo ECS Cluster Phần 2](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/ecs-task-json-2.png)
...
![Khởi tạo Task Definition](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/ecs-task-created.png)
...
![ECS Service](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/ecs-service-status.png)
...
![ECS Service trạng thái hoạt động Healthy](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.4-ECS-Fargate/tasks-status.png)
