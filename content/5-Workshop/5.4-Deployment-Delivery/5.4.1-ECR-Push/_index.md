...
![Create ECR Repository Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-create-1.png)

- **Scan on push**: **Enable**

![Create ECR Repository Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-create-2.png)
...
![Configure Lifecycle Rule 1](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-created.png)
...
![Configure Lifecycle Rule 1](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-lifecycle-1.png)
...
![Configure Lifecycle Rule 2 - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-lifecycle-2.png)

- **Match criteria**: Image count ➔ Count number: 30
- **Action**: Expire
![Configure Lifecycle Rule 2 - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-lifecycle-3.png)
...
![ECR Repository Docker Image List](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.1-ECR-Push/ecr-deploy-terminal.png)
