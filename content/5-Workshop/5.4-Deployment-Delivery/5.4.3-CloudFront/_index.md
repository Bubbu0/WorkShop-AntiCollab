...
![Create Distribution - Choose Plan](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-1.png)
...
![Create Distribution - Get Started](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-2.png)
...
![Create Distribution - Specify Origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-3.png)
...
![Create Distribution - Enable security](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-security.png)

##### Step 5: Review and create
- Review all the configuration details ➔ Click **Create distribution**.
![Create Distribution - Done](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-done.png)
...
![Copy policy from CloudFront](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-policy-1.png)
![Copy policy from CloudFront](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/copy-policy.png)
...
![Paste S3 Bucket Policy](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-policy-2.png)
- Paste the copied JSON policy from CloudFront into the policy editor.
- Click **Save changes** at the bottom of the page.
![Origins Tab List Screen](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-alb-1.png)
...
![Configure ALB Backend Origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-alb-2.png)
...
![Configure ALB Backend Origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-behavior-1.png)
...
![Configure Behavior for Path /api/*](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-behavior-2.png)
...
* **Create Behavior 1 (For `/api/*` REST API)**:
  ...
  ![Error Pages Tab Screen](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-1.png)
...
* **Create Behavior 2 (For `/ws/*` WebSockets)**:
  ...
  ![Configure Custom Error Response 403](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-2.png)
...
![Configure Custom Error Response 404](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-3.png)
...
2. Set up 403 error page:
   ...
   ![Custom Error Responses List Screen](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-4.png)
...
3. Click **Create custom error response** again for 404 error page:
   ...
   ![General Settings Edit Button](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-general-1.png)

##### 4. Configure Root Object & IPv6
1. Go to the **General** tab ➔ under the **Settings** section, click **Edit**.

![Configure Default Root Object index.html](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-general-2.png)

2. Configure as follows:
   - **Default root object**: Enter **index.html** (Crucial to load the landing page from S3).

   ![Default root object](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-status.png)
...
![CloudFront Distribution Completed Domain Name](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-domain.png)
