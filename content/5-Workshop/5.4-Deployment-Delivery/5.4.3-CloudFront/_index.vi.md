...
![Khởi tạo Distribution - Chọn gói cước](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-1.png)
...
![Khởi tạo Distribution - Get started](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-2.png)
...
- Bấm **Next**.
![Khởi tạo Distribution - Specify origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-origin-3.png)


##### Bước 4: Enable security
- Tích chọn **Use monitor mode** ➔ Bấm **Next**.
![Khởi tạo Distribution - Enable security](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-security.png)

##### Bước 5: Review and create
- Kiểm tra lại toàn bộ thông tin ➔ Bấm **Create distribution**.
![Khởi tạo Distribution - Done](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-done.png)

##### Bước 6: Copy policy
1. Truy cập vào Distribution vừa tạo ➔ Chọn tab **Origins**.
2. Tích chọn S3 Origin (ví dụ: `realtime-collab-frontend-...`) ➔ Chọn **Edit**.
![Copy policy từ CloudFront](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-policy-1.png)
3. Cuộn xuống mục **Bucket policy**, thông báo màu vàng kèm nút **Copy policy** sẽ xuất hiện lại để bạn sao chép.
![Copy policy từ CloudFront](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/copy-policy.png)
...
![Dán Bucket Policy trong S3 Permissions](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-policy-2.png)
- Dán toàn bộ chính sách JSON đã copy ở CloudFront vào khung soạn thảo mã.
- Nhấn **Save changes** ở cuối trang để lưu lại.
![Origins tab list](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-alb-1.png)
...
![Khởi tạo ALB Backend Origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-alb-2.png)
...
![Khởi tạo ALB Backend Origin](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-behavior-1.png)
...
![Cấu hình Behavior cho Path /api/*](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-behavior-2.png)
...
* **Tạo Behavior 1 (Dành cho `/api/*` REST API)**:
  ...
  ![Error Pages tab](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-1.png)
...
* **Tạo Behavior 2 (Dành cho `/ws/*` WebSockets)**:
  ...
  ![Cấu hình Custom Error Response 403](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-2.png)
...
![Cấu hình Custom Error Response 404](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-3.png)
...
2. Thiết lập lỗi 403:
   ...
   ![Danh sách Custom Error Responses](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-error-4.png)
...
3. Tiếp tục bấm **Create custom error response** để thiết lập lỗi 404:
   ...
   ![General Settings Edit click](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-general-1.png)

##### 4. Cấu hình Root Object & IPv6
1. Di chuyển sang tab **General** ➔ Tại mục **Settings**, bấm nút **Edit**.

![Cấu hình Default Root Object index.html](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-general-2.png)
...
![Địa chỉ Domain name CloudFront hoàn thành](/WorkShop-AntiCollab/images/5-Workshop/5.4-Deployment-Delivery/5.4.3-CloudFront/cf-domain.png)
