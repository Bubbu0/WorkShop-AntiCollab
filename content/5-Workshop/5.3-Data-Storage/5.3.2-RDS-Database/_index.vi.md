...
![Khởi tạo DB Subnet Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-create.png)
...
![Khởi tạo Parameter Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-details.png)
...
![Eidt Parameter Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-create.png)

![Bắt buộc sử dụng mã hoá SSL](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-edit.png)
...
![Khởi tạo Database - Engine Options](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-engine.png)

- **Availability and durability**: **Multi-AZ DB instance**

![Khởi tạo Database - Settings & Credentials](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/2az.png)
...
![Khởi tạo Database - Master Password](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-settings-2.png)
- **Instance configuration**: db.t3.medium

![Khởi tạo Database - Instance Type](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-instance.png)

- **Storage**:
  - Storage type: `gp3` | Allocated storage: `100 GB`
  - **Enable storage autoscaling**: **Tích chọn** | Maximum storage threshold: `500 GB`

![Khởi tạo Database - Storage Autoscaling](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-storage.png)
- **Connectivity**:
  - **VPC**: realtime-collab-dev
  - **DB Subnet group**: realtime-collab-dev-db-subnet-group
  - **Public access**: Chọn No
![Khởi tạo Database - Connectivity Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-network-1.png)
  - **VPC security group (existing)**: Chọn rds-sg (Xóa bỏ group default nếu có).
![Khởi tạo Database - Connectivity Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-network-2.png)

- **Additional monitoring settings**: 
  - **Log exports**: Chọn PostgreSQL log.
![Khởi tạo Database - Additional Configuration Part 3](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-3.png)

- **Additional configuration**:
  - **Initial database name**: `realtime_collab`
  - **DB parameter group**: Chọn `realtime-collab-dev-pg15-ssl`
![Khởi tạo Database - Additional Configuration Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-1.png)
  - **Backup**:
    - Backup retention period: 7 days
    - Backup window: Chọn Choose a window | **Start time**: 3:00 (UTC) | **Duration**: 1
    - **Copy tags to snapshots**: **Tích chọn**

![Khởi tạo Database - Additional Configuration Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-2.png)
