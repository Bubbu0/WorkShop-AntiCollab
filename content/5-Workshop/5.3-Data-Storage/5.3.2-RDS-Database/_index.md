...
![Create DB Subnet Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-create.png)
...
![Create Parameter Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-details.png)
...
![Edit Parameter Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-create.png)

![Enforce SSL encryption](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-edit.png)
...
![Database creation Engine Options](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-engine.png)

- **Availability and durability**: **Multi-AZ DB instance**

![Database Settings & Credentials](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/2az.png)
...
![Database Master Password settings](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-settings-2.png)
- **Instance configuration**: db.t3.medium

![Database Instance Type](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-instance.png)

- **Storage**:
  - Storage type: `gp3` | Allocated storage: `100 GB`
  - **Enable storage autoscaling**: **Check** | Maximum storage threshold: `500 GB`

![Database Storage Autoscaling](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-storage.png)
- **Connectivity**:
  - **VPC**: realtime-collab-dev
  - **DB Subnet group**: realtime-collab-dev-db-subnet-group
  - **Public access**: Select No
![Database Connectivity Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-network-1.png)
  - **VPC security group (existing)**: Choose rds-sg (Remove the default security group).
![Database Connectivity Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-network-2.png)

- **Additional monitoring settings**:
  - **Log exports**: Check PostgreSQL log
![Database Additional Configuration Part 3](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-3.png)

- **Additional configuration**:
  - **Initial database name**: `realtime_collab`
  - **DB parameter group**: Select `realtime-collab-dev-pg15-ssl`
  
![Database Additional Configuration Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-1.png)
  - **Backup**:
    - Backup retention period: 7 days
    - Backup window: Select Choose a window | **Start time**: 3:00 (UTC) | **Duration**: 1
    - **Copy tags to snapshots**: **Check**
 
![Database Additional Configuration Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-additional-2.png)
