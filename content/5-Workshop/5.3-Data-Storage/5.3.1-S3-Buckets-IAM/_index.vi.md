...
![Khởi tạo S3 Frontend - Tên và Vùng](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-1.png)
...
![Khởi tạo S3 Frontend - Block Public Access và Versioning](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-2.png)

- **Encryption type**: Chọn SSE-S3 (AES-256)
- Bấm **Create bucket**.
![Khởi tạo S3 Frontend - Encryption](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-3.png)
...
![Cấu hình Bucket Policy cho Frontend](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-policy.png)

#### 2. Bucket lưu trữ tệp tin người dùng: `realtime-collab-files-<account-id>`
![Khởi tạo S3 Files - Tên và Vùng](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-1.png)

- **Block public access**: Block all public access **➔ Tích chọn**
- **Bucket Versioning**: Enabled
![Khởi tạo S3 Files - Block Public Access và Versioning](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-2.png)

- **Encryption type**: SSE-S3 (AES-256)
- Bấm **Create bucket**.
![Khởi tạo S3 Files - Encryption](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-3.png)
...
![Cấu hình Bucket Policy cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-policy.png)

- **Lifecycle rules** (Tab Management ➔ Create lifecycle rule):
![Cấu hình Bucket Policy cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-cors.png)

  - **Rule 1**: Tên `archive-workspace-files` | Prefix: `workspace-`

  ![Cấu hình Lifecycle Rules 1 cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-lifecycle-rule-1.1.png)
  ...
  ![Cấu hình Lifecycle Rules 1 cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-lifecycle-rule-1.2.png)
  ...
  ![Cấu hình Lifecycle Rules 2 cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/abort-incomplete-multipart-1.png)
  ...
  ![Cấu hình Lifecycle Rules 2 cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/abort-incomplete-multipart-2.png)
...
- **Cross-origin resource sharing (CORS)** (Tab Permissions ➔ CORS):
  ...
  ![Cấu hình CORS cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/file-CORS-1.png)

  ![Cấu hình CORS cho Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/file-CORS-2.png)
...
3. Trong giao diện tạo Role:
   ...
   ![Khởi tạo ECS Task Execution Role](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/create-role-1.png)
...
![Khởi tạo ECS Task Execution Role](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/create-role-2.png)
...
```
![Tạo Inline Policy ecr-pull](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/ecr-pull-policy.png)

* Bấm **Next**, đặt tên Policy là `ecr-pull` và chọn **Create policy**.

![Tạo Inline Policy ecr-pull](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-exec-policy-ecr.png)
...
```
![Tạo Inline Policy secrets-execution](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/cloudwatch-logs-ecs.png)
...
```
![Tạo Inline Policy secrets-execution](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-exec-policy-secrets.png)
...
2. Chọn cấu hình tương tự như Bước 1:
   ...
   ![Khởi tạo ECS Task Role](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-task-role-create.png)
...
![Khởi tạo ECS Task Role](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/ecsTaskRole-realtime-collab-dev.png)
...
```
![Tạo Inline Policy s3-file-storage](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-task-policy-s3.png)
...
```
![Tạo Inline Policy secrets-task](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/secrets-task.png)
