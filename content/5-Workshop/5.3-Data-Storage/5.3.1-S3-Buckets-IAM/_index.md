...
![Create S3 Frontend - Name and Region](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-1.png)
...
![Create S3 Frontend - Block Public Access and Versioning](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-2.png)

- **Encryption type**: Choose SSE-S3 (AES-256)
- Click **Create bucket**.
![Create S3 Frontend - Encryption](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-3.png)
...
![Configure Bucket Policy for Frontend](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-frontend-policy.png)

#### 2. Application File Storage Bucket: `realtime-collab-files-<account-id>`
![Create S3 Files - Name and Region](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-1.png)

- **Block public access**: Block all public access **➔ Enabled**
- **Bucket Versioning**: Enabled
![Create S3 Files - Block Public Access and Versioning](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-2.png)

- **Encryption type**: SSE-S3 (AES-256)
- Click **Create bucket**.
![Create S3 Files - Encryption](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-3.png)
...
![Configure Bucket Policy for Files](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-policy.png)

- **Lifecycle rules** (Management tab ➔ Create lifecycle rule):
![Configure S3 Files CORS](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-cors.png)

  - **Rule 1**: Name `archive-workspace-files` | Prefix: `workspace-`

  ![Configure Lifecycle Rule 1 for Files - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-lifecycle-rule-1.1.png)
  ...
  ![Configure Lifecycle Rule 1 for Files - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/s3-files-lifecycle-rule-1.2.png)
  ...
  ![Configure Lifecycle Rule 2 for Files - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/abort-incomplete-multipart-1.png)
  ...
  ![Configure Lifecycle Rule 2 for Files - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/abort-incomplete-multipart-2.png)
...
- **Cross-origin resource sharing (CORS)** (Permissions tab ➔ CORS):
  ...
  ![Configure CORS for Files - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/file-CORS-1.png)
  ![Configure CORS for Files - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/file-CORS-2.png)
...
3. In the creation wizard:
   ...
   ![Create ECS Task Execution Role - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/create-role-1.png)
...
![Create ECS Task Execution Role - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/create-role-2.png)
...
![Create Inline Policy](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-exec-role-create.png)
...
```
![Configure Inline Policy ecr-pull](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/ecr-pull-policy.png)

* Click **Next**, name the policy `ecr-pull`, and click **Create policy**.

![Create Inline Policy ecr-pull](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-exec-policy-ecr.png)
...
```
![Configure Inline Policy cloudwatch-logs-ecs](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/cloudwatch-logs-ecs.png)
...
```
![Create Inline Policy secrets-execution](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-exec-policy-secrets.png)
...
2. Select the same trusted settings as in Step 1:
   ...
   ![Create ECS Task Role - Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-task-role-create.png)
...
![Create ECS Task Role - Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/ecsTaskRole-realtime-collab-dev.png)
...
```
![Create Inline Policy s3-file-storage](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/iam-task-policy-s3.png)
...
```
![Configure Inline Policy secrets-task](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.1-S3-Buckets-IAM/secrets-task.png)
