...
![Khởi tạo Redis Cache Subnet Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-subnet-group-create.png)
...
![Khởi tạo Redis - Cấu hình Settings Phần 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-1.png)
...
![Khởi tạo Redis - Cấu hình Settings Phần 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-2.png)
...
![Khởi tạo Redis - Cache settings](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-3.png)
...
![Khởi tạo Redis - Kết nối Connectivity](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-1.png)
...
![Khởi tạo Redis - Advanced Settings](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-2.png)
...
![Khởi tạo Redis - Advanced Settings](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-3.png)

##### 2. Backup & Maintenance
- **Enable automatic backups**: Bỏ tích chọn.
- **Auto minor version upgrade**: Tích chọn **Enable**.

![Danh sách cụm Redis ở trạng thái khởi tạo](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-status.png)
