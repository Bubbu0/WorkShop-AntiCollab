...
![Create Redis Cache Subnet Group](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-subnet-group-create.png)
...
![Configure Redis Settings Part 1](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-1.png)
...
![Configure Redis Settings Part 2](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-2.png)
...
![Configure Redis Settings Part 3](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-settings-3.png)
...
![Configure Redis Connectivity](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-1.png)
...
![Configure Redis Advanced Security & Auth Token](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-2.png)

- **Selected security groups**: Click **Manage** ➔ Select **redis-sg** created in Step 4 (ensure default is unchecked) ➔ click **Save**.

![Configure Redis Security Groups](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-advanced-3.png)

##### 2. Backup & Maintenance
- **Enable automatic backups**: Uncheck.
- **Auto minor version upgrade**: Select **Enable**.

![Redis Cluster List Status](/WorkShop-AntiCollab/images/5-Workshop/5.3-Data-Storage/5.3.3-ElastiCache-Redis/redis-create-status.png)
