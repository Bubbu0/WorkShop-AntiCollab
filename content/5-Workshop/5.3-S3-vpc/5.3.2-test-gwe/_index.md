...
![Create bucket](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/create-bucket.png)
...
![Bucket name](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/bucket-name.png)

+ Leave other fields as they are (default)
+ Scroll down and choose **Create bucket**

![Create](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/create-button.png) 

+ Successfully create S3 bucket.

![Success](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/bucket-success.png)
...
![system manager](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/sm.png)

2. From the **Systems Manager** menu, find **Node Management** in the left menu and click **Session Manager**:

![system manager](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/sm1.png)
...
![Start session](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/start-session.png)

**Session Manager** will open a new browser tab with a shell prompt: sh-4.2 $

![Success](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/start-session-success.png)
...
![Change user's dir](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/cli1.png)
...
![Create file](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/cli-file.png)
...
![Uploaded](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/uploaded.png)
...
![Check S3](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/check-s3-bucket.png)
