...
![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/endpoints.png)

3. Trong Create endpoint console:
+ Đặt tên cho endpoint: s3-gwe
+ Trong service category, chọn **aws services**

![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/create-s3-gwe1.png)

+ Trong **Services**, gõ "s3" trong hộp tìm kiếm và chọn dịch vụ với loại **gateway**

![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/services.png)
...
![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/vpc.png)
...
![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/policy.png)

+ Không thêm tag vào VPC endpoint.
+ Click Create endpoint, click x sau khi nhận được thông báo tạo thành công.

![endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.3-S3-vpc/complete.png)
