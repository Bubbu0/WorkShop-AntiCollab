...
![create stack](/WorkShop-AntiCollab/images/5-Workshop/5.2-Prerequisite/create-stack1.png)

+ Lựa chọn 2 mục acknowledgement 
+ Chọn Create stack

![create stack](/WorkShop-AntiCollab/images/5-Workshop/5.2-Prerequisite/create-stack2.png)

Quá trình triển khai CloudFormation cần khoảng 15 phút để hoàn thành.

![complete](/WorkShop-AntiCollab/images/5-Workshop/5.2-Prerequisite/complete.png)

+ 2 VPCs đã được tạo

![vpcs](/WorkShop-AntiCollab/WorkShop-AntiCollab/images/5-Workshop/5.2-Prerequisite/vpcs.png)

+ 3 EC2s đã được tạo

![EC2](/WorkShop-AntiCollab/images/5-Workshop/5.2-Prerequisite/ec2.png)