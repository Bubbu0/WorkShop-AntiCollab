...
![route 53 diagram](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53.png)
...
![Create stack](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/create-stack.png)

![Button](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/create-stack-button.png)
...
![ec2 id](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/ec2-onprem-id.png)
...
![rt](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/rt.png)

5. Click Add route.
+ Destination: CIDR block của Cloud VPC
+ Target: ID của infra-vpngw-test instance (bạn đã lưu lại ở bước trên)

![add route](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/add-route.png)
