...
![name](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint1.png)
...
![service](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint2.png)
...
![vpc](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint3.png)

5. Select 2 subnets in the following AZs: us-east-1a and us-east-1b

![subnets](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint4.png)

6. For Security group, choose SGforS3Endpoint:

![sg](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint5.png)

7. Keep the default policy - full access and click Create endpoint

![success](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint-success.png)
