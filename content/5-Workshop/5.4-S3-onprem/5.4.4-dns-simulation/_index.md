...
![hosted zone](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/hosted-zone.png)

2. Create a new record in the Private Hosted Zone:

![Create record](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/create-record1.png)
...
![record1](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/record1.png)
...
![record 2](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/record2.png)

The new records appear in the Route 53 console:

![result](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/result.png)
...
![Inbound endpoint](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-1.png)

3. Copy the two IP addresses listed to your text editor

![Ip addresses](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-2.png)

4. From the Route 53 menu, choose **Resolver** > **Rules**, and click **Create rule**:

![Ip addresses](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-3.png)
...
![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-4.png)

+ VPC: VPC On-prem
+ Outbound endpoint: VPCOnpremOutboundEndpoint

![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-5.png)

+ Target IP Addresses: Enter both IP addresses from your text editor (inbound endpoint addresses) and then click Submit

![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-6.png)
You have successfully created resolver forwarding rule. 

![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/route53-7.png)

#### Test the on-premises DNS Simulation

1. Connect to **Test-Interface-Endpoint EC2 instance** with **Session manager**

![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/test1.png)
...
![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/dig.png)
...
![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/subnet.png)
...
![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/endpoint.png)

5. Terminate your Session Manager session:

![create rule](/WorkShop-AntiCollab/images/5-Workshop/5.4-S3-onprem/terminal.png)
